...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['Title']) || $_SESSION['Description'] || $_SESSION['Price'] || $_SESSION['Category'] || isset($_SESSION['Current-image']) || $_SESSION['image'] || isset($_SESSION['Featured']) || $_SESSION['Active']) {
