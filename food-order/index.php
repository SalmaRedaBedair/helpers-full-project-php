...
<section class="categories">
    <div class="container">
        ...
        if ($count >= 1) {
            ...
            echo "<div class='error-text text-center'>No categories added.</div>";
        }
        ?>
...
<section class="food-menu">
    <div class="container">
        ...
        if ($count2 > 0) {
                ...
                <div class="food-menu-box">
                    <div class="food-menu-img">
                        ...
                        if ($image_name != "") {
                            ...
                            echo "<div class='error-text'>Image is not available</div>";
                        }
            ...
            echo "<div class='error-text text-center'>Food is not available</div>";
        }
        ?>
